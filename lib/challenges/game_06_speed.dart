...
class Game_06_speed extends StatefulWidget {
  final String gameID;
  final int userID;

  Game_06_speed({required this.gameID, required this.userID});

  @override
  _Game_06_speed createState() => _Game_06_speed();
}

class _Game_06_speed extends State<Game_06_speed> {
  Timer? _timer;
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Row(
            children: <Widget>[
              Image.asset(
                Game.getGameIcon("Fast 30 min"), // Replace with your image path
                width: 30, // Adjust the width as needed
                height: 30, // Adjust the height as needed
              ),
              const SizedBox(
                  width: 15), // Add some space between the title and the icon
              const Text("Fast 30 min",
                  style: TextStyle(
        ...
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  'Your challenge is to walk for 30 minutes with your maximal speed',
